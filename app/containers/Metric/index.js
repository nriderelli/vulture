...
// import local files
import Table from 'components/Metric/Table';
import Card from 'components/Metric/Card';
import Text from './Text';
import Header from './Header';
import A from './A';
/* eslint-disable react/prefer-stateless-function */
export class Metric extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      isOpen: true,
  ...
  render() {
    return (
      <div>
        <Helmet>
          <title>Metrics</title>
          <meta name="Metrics" content="Metrics of the application" />
        </Helmet>
        <div>
